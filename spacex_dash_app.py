...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(values=values, names=labels, title=f'Launch Outcomes for {entered_site}')
...
def update_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload vs Launch Outcome for {entered_site}')
